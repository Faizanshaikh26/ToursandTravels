            ...
            <div className="footer-content">
              ...
              <div className="footer-content-column">
                <div className="footer-call-to-action">
                  ...
                  {/* Replace anchor tag with Link */}
                  <Link className="footer-call-to-action-button button" to="/contact"> Get in Touch </Link>
                </div>
                <div className="footer-call-to-action">
                  <h2 className="footer-call-to-action-title"> You Call Us</h2>
                  <p className="footer-call-to-action-link-wrapper"> 
                    {/* Replace anchor tag with Link */}
                    <Link className="footer-call-to-action-link" to="tel:0124-64XXXX"> 0124-64XXXX </Link>
                  </p>
                </div>
              </div>
              <div className="footer-social-links"> 
                ...
                <Link className="footer-social-link linkedin" to="#">
                ...
                <Link className="footer-social-link twitter" to="#">
                ...
                <Link className="footer-social-link youtube" to="#">
                ...
                <Link className="footer-social-link github" to="#">
