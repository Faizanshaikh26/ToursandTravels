export const galleryData = [
    ...
    {
      image: 'https://i.ibb.co/jrRb11q/img1.jpg',
      name: 'Finland',
      description: 'Finland is a Northern European nation bordering Sweden, Norway, and Russia. Its capital, Helsinki, occupies a peninsula and surrounding islands in the Baltic Sea.',
      "author": "Jane Smith",
    "title": "Discovering the Great Barrier Reef",
    "topic": "Nature"
    },
    {
      image: 'https://i.ibb.co/NSwVv8D/img1.jpg',
      name: 'Iceland',
    ...
    {
      image: 'https://i.ibb.co/Bq4Q0M8/img1.jpg',
      name: 'Australia',
    ...
    "title": "Chasing Northern Lights in Norway",
    "topic": "Nature"
    },
    {
      image: 'https://i.ibb.co/jTQfmTq/img1.jpg',
      name: 'Netherland',
      description: 'The Netherlands, a country in northwestern Europe, is known for a flat landscape of canals, tulip fields, windmills and cycling routes.',
